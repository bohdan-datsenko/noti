...
export const Drawer: FC<DrawerProps> = ({ children, actions, isOpen, handleClose }) => {
    return (
        ...
        >
            ...
            <button className='absolute z-50 bg-amber-100 p-2 rounded-full hover:bg-amber-300'>
                <svg className='hover:fill-white' fill="rgb(251 191 36)" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
